...
public class App {
    ...
    private static void readCSV() throws IOException {
        ...
        String[] HEADERS = { "Curso", "Unidade Curricular", "Turno", "Turma", "Inscritos no turno", "Dia da semana",
                "Hora início da aula", "Hora fima da aula", "Data da aula",
                "Características da sala pedida para a aula", "Sala atribuída à aula" };

        try (
                Reader reader = Files.newBufferedReader(Paths.get("schedule_manager/src/samples/HorarioDeExemplo.csv"));
